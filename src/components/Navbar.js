...
const Navbar = () => {
  ...
  const { checked, dispatch } = stocksContext;
  ...
  return (
    <div className={`navbar  ${!checked && 'display-none'}`}>
      <header className="navbar--header--container">
        ...
        <Close className="navbar--close button" onClick={closeNavbar}/>
      </header>

      <main className="navbar--body">
        <div
          id="admin"
          className="navbar--body--container"
        ...
        >
          ...
          {analytics && (
            <ul className="navbar--sub--list">
              <li>
                <button className="navbar--sub--list--item active--sub--list--item">
                  Teams
                </button>
              </li>
              <li>
                <button className="navbar--sub--list--item">
                  Knowledge Base
                </button>
              </li>
              <li>
              ...
              <li>
                <button className="navbar--sub--list--item">Help Center</button>
              </li>
            </ul>
          )}
        </div>
